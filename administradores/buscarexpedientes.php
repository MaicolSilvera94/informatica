...
<?php
    ...
    $query = "SELECT * FROM transferencias WHERE cedulaprocesado = ".$_SESSION['cedula']." ORDER By ID DESC";

    if (isset($_POST['consulta'])) {
    	$q = $conn->real_escape_string($_POST['consulta']);
      $query = "SELECT * FROM transferencias WHERE cedulaprocesado = ".$_SESSION['cedula']." AND (id LIKE '%$q%' OR nombreapellido LIKE '%$q%' OR cedula LIKE '%$q%') ORDER By ID DESC";
    }
