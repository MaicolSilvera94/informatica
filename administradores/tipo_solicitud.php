         ...
         if($_POST['guardar'] == 'guardar' && $_POST['nombreapellido'] != ''  ){
             ...
             if ( $firmasolisitante == $_SESSION['password']) {
              if ($sistemas != '' && $equipos == '' && $redes == '') {
                $sql = 'INSERT INTO servicios (nombreapellido, cargo, dependencia, interno, cedula, fecha_add, sistemas, sistema, visible, conformidad, obsgeneral, solicitado, estado)
               VALUES (:nombreapellido, :cargo, :dependencia, :interno, :cedula, NOW(), :sistemas, :sistema, 1, 1, :obsgeneral, :solicitado, "PENDIENTE")';
               $data = array(
                ...
                if ($sistemas == '' && $equipos != '' && $redes == '') {
                  $sql = 'INSERT INTO servicios (nombreapellido, cargo, dependencia, interno, cedula, fecha_add, equipos, visible, conformidad, obsgeneral, solicitado, estado)
                  VALUES (:nombreapellido, :cargo, :dependencia, :interno, :cedula, NOW(), :equipos, 1, 1, :obsgeneral, :solicitado, "PENDIENTE")';
                  $data = array(
                       'nombreapellido' => $nombreapellido,
                       'cargo' => $cargo,
                       'dependencia' => $dependencia,
                  ...
                  if ($sistemas == '' && $equipos == '' && $redes != '') {
                    $sql = 'INSERT INTO servicios (nombreapellido, cargo, dependencia, interno, cedula, fecha_add, redes, visible, conformidad, obsgeneral, solicitado, estado)
                    VALUES (:nombreapellido, :cargo, :dependencia, :interno, :cedula, NOW(), :redes, 1, 1, :obsgeneral, :solicitado, "PENDIENTE")';
                    $data = array(
                         'nombreapellido' => $nombreapellido,
                         'cargo' => $cargo,
                         'dependencia' => $dependencia,
