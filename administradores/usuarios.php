  ...
  <div class="content-wrapper">
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="usuarios.php"></i> Usuarios</a></li>
      </ol>
    </section>
      ...
      <div class="panel">
        ...
        <tbody>
          <?php foreach ($query->fetchAll() as $file ) {  ?>
           <tr>
            <td style="vertical-align:middle;"><?php echo $file['id']; ?></td>
            <td>
              <?php if ($file['avatar'] != ''){ ?>
                <img src="../images/usuarios/<?php echo $file['avatar']?>" width="50px">
              <?php } else {?>
                <img src="../images/usuarios/no-avatar.png" width="60px">
              <?php } ?>

            </td>
            <td style="vertical-align:middle;"><?php echo $file['nombre']; ?> </td>
            <td style="vertical-align:middle;"><?php echo $file['email']; ?></td>
