...
<div class="wrapper">
  ...
  <?php
   if (isset($_SESSION['cedula'])) {
    ...
    $sql = "SELECT * FROM servicios WHERE visible = 0  AND conformidad = 1  AND cedula = " .$_SESSION['cedula'];
          ...
          <?php foreach ($query->fetchAll() as $file ) {  ?>
           <tr>
            ...
            <td class="text-center">
              <a class="btn btn-warning btn-xs" href="conformidad_edit.php?id=<?php echo $file['id']; ?>"> <i class="">Confirmar</i></a>
            </td>
          </tr>
          <?php } ?>
        </tbody>
