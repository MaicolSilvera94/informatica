  ...
  <?php
    ...
    if( isset($_POST) ){
        ...
        if($_POST['guardar'] == 'guardar' && $_POST['titulo'] != '' ){
            ...
            $sql = 'INSERT INTO cms (titulo, descripcion_corta, descripcion_larga, imagen, icono, video, visible, fecha_add ) VALUES (:titulo, :descripcion_corta, :descripcion_larga, :imagen, :icono, :video, :visible, NOW() )';
      ...
      <div class="panel">
        <div class="row">
            <form action="cms_add.php" method="POST" name="form">
                ...
                <div class="form-group col-md-3">
                    <label>Icono</label>
                    <input type="text" name="icono" required class="form-control input-lg">
                </div>
