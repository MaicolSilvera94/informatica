...
<div class="wrapper">
  ...
  <?php
     ...
     if(isset($_POST['id']) && isset($_POST['eliminar'])){
        ...
        if(isset($_POST['id']) > 0 ) {
            $sql = "DELETE FROM cms WHERE id = " . $_POST['id'];
            $query = $connection->prepare($sql);
           // $query->execute();
            ...
            try {
                ...
                $mensaje = '<p class="alert alert-success">CMS Eliminado</p>';

            } catch (PDOException $e) {
                $mensaje = '<p class="alert alert-warning">Error al eliminar CMS '. $e->getMessage() .' </p>';
            }
...
<div class="panel">
      ...
      <div class="panel">
        <div class="row">
         ...
         <div class="col-md-12">
         <?php if ($total > 0) { ?>
                <form action="servicios_delete.php" method="POST">
