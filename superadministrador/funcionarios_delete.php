        ...
        if(isset($_POST['id']) > 0 ) {
           ...
           // $query->execute();
            ...
            try {
                ...
                $mensaje = '<p class="alert alert-success">Funcionario Eliminado</p>';

            } catch (PDOException $e) {
                $mensaje = '<p class="alert alert-warning">Error al eliminar Funcionario '. $e->getMessage() .' </p>';
            }
      ...
      <div class="panel">
        <div class="row">
         ...
         <?php if ($total > 0) {
           ...
           ?>
                <form action="funcionarios_delete.php" method="POST">
                    <p class="alert alert-warning">Confirmar la eliminacion del registro Nro. <?php echo $_GET['id']; ?> del Funcionario <?php echo $funcionarios['nombre']; ?></p>
