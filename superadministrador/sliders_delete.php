        ...
        if(isset($_POST['id']) > 0 ) {
           ...
           // $query->execute();
            ...
            try {
                ...
                $mensaje = '<p class="alert alert-success">Sliders Eliminado</p>';

            } catch (PDOException $e) {
                $mensaje = '<p class="alert alert-warning">Error al eliminar Sliders '. $e->getMessage() .' </p>';
            }
...
<div class="panel">
      ...
      <div class="panel">
        <div class="row">
         ...
         <div class="col-md-12">
         <?php if ($total > 0) { ?>
                <form action="sliders_delete.php" method="POST">
