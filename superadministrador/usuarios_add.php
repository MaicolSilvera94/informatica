...
<div class="wrapper">
  ...
  <?php
    ...
    if( isset($_POST) ){
        ...
        if($_POST['guardar'] == 'guardar' && $_POST['nombre'] != '' && $_POST['password'] != '' && $_POST['activo'] != '' && $_POST['apellido'] != '' ){
            ...
            $sql = 'INSERT INTO usuarios (nombre, apellido, cargo, dependencia, cedula,  password, avatar, activo, fecha_add)
            VALUES (:nombre, :apellido, :cargo, :dependencia, :cedula, :password, :avatar, :activo, NOW() )';
