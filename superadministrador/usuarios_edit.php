  ...
  <?php
       ...
       if(isset($_POST)){
            ...
            if($_POST['actualizar'] == 'actualizar' && $_POST['nombre'] != '' && $_POST['id'] > 0){
                   $sql = "UPDATE usuarios set nombre = :nombre, apellido = :apellido, cargo = :cargo, dependencia = :dependencia,
                    cedula = :cedula, password = :password, activo=:activo WHERE id = " . $_POST['id'];
                   $data =  array(
                        'nombre' => $_POST['nombre'],
        ...
        <div class="row">
          <?php if($total > 0) {
            ...
            <form action="usuarios_edit.php" method="POST">
                ...
                <div class="form-group col-md-3">
                    <label>Cargo</label>
                    <input type="text" name="cargo" value="<?php echo $usuario['cargo']; ?>" required class="form-control">
                </div>
                <div class="form-group col-md-3">
                    <label>Dependencia</label>
                    <input type="text" name="dependencia" value="<?php echo $usuario['dependencia']; ?>" required class="form-control">
                </div>
                <div class="form-group col-md-3">
                    <label>Cedula</label>
                    <input type="text" name="cedula" value="<?php echo $usuario['cedula']; ?>" required class="form-control">
                </div>
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="password" name="password" value="<?php echo $usuario['password']; ?>" class="form-control">
                </div>
          ...
          <?php } else {  ?>
            ...
            <a href="usuarios.php" class="btn btn-warning">El usuario actualizado, volver a la lista</a>
